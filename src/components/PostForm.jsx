...
export default function PostForm({ savePost, post }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <label>
                Board Game Name
                <input type="text" value={title} placeholder="Type a title" onChange={e => setTitle(e.target.value)} className="input"/>
            </label>
            <label>
                Difficulty level <br />
            ...
            <label>
                Mininimum age
                <input type="text" value={age} placeholder="Type a body text" onChange={e => setAge(e.target.value)} className="input"/>
            </label>

            <label>
                Avegare game duration
                <input type="text" value={duration} placeholder="Type a body text" onChange={e => setDuration(e.target.value)} className="input"/>
            </label>

            <label>
                Description
                <input type="text" value={body} placeholder="Type a body text" onChange={e => setBody(e.target.value)} className="input"/>
            </label>

            <label>
                Image URL
                <input type="text" value={imageFile} onChange={e => setImageFile(e.target.value)} className="input"/>
            ...
            <label>                                              
                In Vestergade
                <input type="text" value={locationVestergade} placeholder="Shelf index" onChange={e => setLocationVestergade(e.target.value)} className="input-small"/>
            </label>
            <label>                                              
                In Fredensgade
                <input type="text" value={locationFredensgade} placeholder="Shelf index" onChange={e => setLocationFredensgade(e.target.value)} className="input-small"/>
            </label>
            <label>                                              
                In Aalborg
                <input type="text" value={locationAalborg} placeholder="Shelf index" onChange={e => setLocationAalborg(e.target.value)} className="input-small"/>
            </label>
            <label>                                              
                In Kolding
                <input type="text" value={locationKolding} placeholder="Shelf index" onChange={e => setLocationKolding(e.target.value)} className="input-small"/>
            </label>
            </div>
